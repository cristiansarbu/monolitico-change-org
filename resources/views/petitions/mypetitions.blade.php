            ...
            @foreach($petitions as $petition)
                <div class="col">
                    <div class="card card-causa shadow mw-desktop-card-causa flex-1 mx-auto position-relative">
                        <img src="{{ asset('petitions/' . $petition->files[0]->file_path) }}" alt="" srcset="" style="height: 170px; object-fit: cover;">
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <button class="btn-firmar fw-bold text-body mt-3"><a
                                    class="text-decoration-none text-body stretched-link" href="{{ route('petitions.show', $petition->id) }}">Ver esta
                                    petición</a></button>
                        </div>
                    </div>
                </div>
